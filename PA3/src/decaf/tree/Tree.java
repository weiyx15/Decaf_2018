...
public abstract class Tree {
    ...
    public static final int GUARDED = SCOPY + 1;
    public static final int GUARD = GUARDED + 1;
    public static final int ARRAYCONSTANT = GUARD + 1;
    public static final int ARRAYCOPY = ARRAYCONSTANT + 1;
    public static final int ARRAYAPPEND = ARRAYCOPY + 1;
    public static final int SUBARRAY = ARRAYAPPEND + 1;
    public static final int BOUNDVARIABLE = SUBARRAY + 1;
    public static final int FOREACHSTMT = BOUNDVARIABLE + 1;
    public static final int DYNAMICINDEX = FOREACHSTMT + 1;
    public static final int COMPREHENSION = DYNAMICINDEX + 1;
    ...
    public static class ClassDef extends Tree {
        ...
        public ClassDef(boolean is_sealed, String name, String parent, List<Tree> fields,
    			Location loc) {
    		super(CLASSDEF, loc);
   ...
   public static class Ident extends LValue {
       ...
       public Ident(Expr owner, String name, Location loc, boolean is_var) {
           super(IDENT, loc);
   		this.owner = owner;
   		this.name = name;
   		this.is_var = is_var;
    ...
    public static class Guarded extends Tree {
    	...
    	public Guarded(List<Guard> guardList, Location loc)
    	{
    		super(GUARDED, loc);
	  ...
	  public static class BoundVariable extends Tree {
		...
		public BoundVariable(String name, TypeLiteral type, Location loc)
		{
	...
	/**
	 * Edit by weiyx15 to use block to enable local scope
	 */
    public static class ForeachStmt extends Tree {
    	...
    	public Block block;
    	public ForeachStmt
    	(BoundVariable bVar, Expr inExpr, Expr whileExpr, Block block, Location loc)
    	{
    ...
    public static class SubArray extends Expr {
    	...
    	public Expr parent, left, right;
    	
    	public SubArray(Expr parent, Expr left, Expr right, Location loc)
    	{
    		super(SUBARRAY, loc);
    		this.parent = parent;
    		this.left = left;
    ...
    /**
     * A constant array given literally.
     * @param List<Expr>: List<Expr> representation
     */
   public static class ArrayConst extends Expr {

       public List<Expr> elist;

       public ArrayConst(List<Expr> elist, Location loc) {
   ...
   public static class Scopy extends Tree {
	      ...
	      public Scopy(Ident left, Expr expr, Location loc) {
	          super(SCOPY, loc);
	  		this.left = left;
	  		this.expr = expr;
	      }
  ...
  /**
   * 
   * Dynamic array index expression with default
   *
   */
  public static class DynamicIndex extends Expr {
  	
  	public Expr parent, ind, def;
  	
  	public DynamicIndex(Expr parent, Expr ind, Expr def, Location loc)
  	{
  		super(SUBARRAY, loc);
  		this.parent = parent;
  		this.ind = ind;
  	...
  	@Override
  	public void accept(Visitor visitor) {
  		visitor.visitDynamicIndex(this);
  	}
  ...
  /**
   * 
   * Python-style array comprehesion expression
   *
   */
  public static class Comprehension extends Expr {
  	...
  	public Comprehension(String name, Expr expr1, Expr expr2, Expr expr3, Location loc)
  	{
    ...
    public static abstract class Visitor {
        ...
        public void visitDynamicIndex(DynamicIndex that) {
            visitTree(that);
        }
