...
public class TransPass1 extends Tree.Visitor {
	...
	public void visitMethodDef(Tree.MethodDef funcDef) {
		...
		/**
		 * Edit by weiyx15 to visit Stmt with assign operation
		 * WARNING: Not to visit all the stmt !!!
		 */
		for (Tree t : funcDef.body.block)
		{
	...
	/**
	 * Edit by weiyx15 to visit "var identifier"
	 */
	@Override
