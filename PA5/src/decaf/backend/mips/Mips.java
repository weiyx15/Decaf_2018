...
public class Mips implements MachineDescription {
	...
	public Mips() {
		...
		regAllocator = new GraphColorRegisterAllocator(fpTemp, callingConv, GENERAL_REGS);// self-written alg
//		regAllocator = new BruteRegisterAllocator(fpTemp, callingConv, GENERAL_REGS);	// pre-written alg
