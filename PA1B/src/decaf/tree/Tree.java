...
public abstract class Tree {
    ...
    public static final int PARGUARD = SCOPY + 1;
    public static final int GUARD = PARGUARD + 1;
    ...
    public static final int COLON = ARRAYAPPEND + 1;
    public static final int DEFAULT = COLON + 1;
    public static final int VARASSIGN = DEFAULT + 1;
    public static final int COMPREHENSION = VARASSIGN + 1;
    public static final int FOREACHSTMT = COMPREHENSION + 1;
    public static final int BOUNDVARIABLE = FOREACHSTMT + 1;
    ...
    public static class VarAssign extends Tree {
    	...
    	public VarAssign(String left, Expr right, Location loc)
    	{
    		super(VARASSIGN, loc);
    		this.left = left;
    		this.right = right;
    ...
    public static class ParGuard extends Tree {
    	
    	public ArrayList<Guard> guards;
    	
    	public ParGuard(ArrayList<Guard> guards, Location loc)
    	{
    		super(PARGUARD, loc);
    		this.guards = guards;
    	}
    ...
    public static class Default extends Expr {
    	...
    	public Default(Expr expr1, Expr expr2, Location loc)
    	{
    		super(DEFAULT, loc);
    		this.expr1 = expr1;
    		this.expr2 = expr2;
    ...
    public static class Range extends Expr {
    	...
    	public Range(Expr expr1, Expr expr2, Location loc)
    	{
    		super(COLON, loc);
    		this.expr1 = expr1;
    		this.expr2 = expr2;
    ...
    public static class Comprehension extends Expr {
    	...
    	public Comprehension(Expr expr1, String ident, Expr expr2, Expr expr3, Location loc)
    	{
    ...
    public static abstract class Visitor {
        ...
        {
        	visitArrayConst(that);
        }
        
        public void visitParGuard(ParGuard that)
        {
        	visitParGuard(that);
        }
