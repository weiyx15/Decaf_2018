...
"%%"				{ return operator(Parser.ARRAYCOPY);	}
"++"				{ return operator(Parser.ARRAYAPPEND);	}
"|||"				{ return operator(Parser.PARGUARD);		}
"[|"				{ return operator(Parser.LEFTCOMPREHEN);}
"|]"				{ return operator(Parser.RIGHTCOMPREHEN);}
